...
\include{cover}\cleardoublepage  % Title/Cover page
...
\include{content/0_abstract}\cleardoublepage  % Abstract
...
\include{content/1_intro}  % Chapter 1: Introduction
\include{content/Theoretical_basics/0_electric_motor_basics}  % Chapter
\include{content/Theoretical_basics/1_motor_control_basics}  % Chapter
...
%\include{content/9_appendix}  % Appendix content
